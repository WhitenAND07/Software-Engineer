...
public class FutureSellTest {
     ...
     * final and same currencys in pricePerShare and final currency, of class FutureSell.
     */
    @Test
    public void evaluateFutureBuyCorrectWithDifferentCurrencyInTicket() throws EvaluationException {
        ...
        FutureSell futureSell = new FutureSell(ticket, 10, pricePerShare);
        Money expResult = new Money(new BigDecimal(8.90), currencyTo);
        Money result = futureSell.evaluate(currencyTo, moneyEx, stockEx);
        assertEquals(expResult, result);
    }
    /**
     * Test of evaluate method with differents currencys in pricePerShare and currency 
     * final and same currencys in ticket and final currency, of class FutureSell.
     */
    @Test
    ...
    /**
     * Test of evaluate method with Ticket not exist, of class FutureSell.
     */
